...
char* get_mime_type(const char* filename) {
    ...
    if (strcmp(ext, ".html") == 0) return "text/html"; //HTML
    if (strcmp(ext, ".css") == 0) return "text/css"; //CSS
    if (strcmp(ext, ".js") == 0) return "application/javascript"; //Javascript
    if (strcmp(ext, ".json") == 0) return "application/json"; //JSON
    if (strcmp(ext, ".png") == 0) return "image/png"; //PNG image
    if (strcmp(ext, ".jpg") == 0 || strcmp(ext, ".jpeg") == 0) return "image/jpeg"; //JPEG image
    if (strcmp(ext, ".gif") == 0) return "image/gif"; //GIF image
    if (strcmp(ext, ".svg") == 0) return "image/svg+xml"; //SVG image
    if (strcmp(ext, ".txt") == 0) return "text/plain"; //Plain text
    if (strcmp(ext, ".xml") == 0) return "application/xml"; //XML document
    if (strcmp(ext, ".pdf") == 0) return "application/pdf"; //PDF document
